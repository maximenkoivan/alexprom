...
<div id="modal-callback"
    ...
    <div class="modal__overlay" tabindex="-1" data-custom-close>
        <div class="modal__container modal__container--callback" role="dialog" aria-modal="true">
            ...
            <form class="modal__form modal__form--callback" action="/request/lightmsk/feedback.php">
...
<div class="call">
    ...
    <div data-popup class="call__popup">
        ...
        <form class="call__form" action="/request/lightmsk/feedback.php">
            ...
            <div class="call__submit">
                <button type="submit"
                        ...
                        data-send-request="callbackMsk"><?= $arResult['PROPERTIES']['TEXT_BTN_MODAL_2']['~VALUE'] ?></button>
            </div>
        </form>
    </div>
    ...
    <div class="modal__overlay" tabindex="-1" data-custom-close>
        ...
        <div class="modal__container modal__container--order" role="dialog" aria-modal="true">
            ...
            <div data-order class="order">
                ...
                <form data-order-form class="order__form" action="/request/lightmsk/feedback.php">
