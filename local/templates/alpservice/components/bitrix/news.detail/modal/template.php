    ...
    <div class="modal__overlay" tabindex="-1" data-custom-close>
        <div class="modal__container modal__container--callback" role="dialog" aria-modal="true">
            ...
            <div class="form-index-block">
                <form action="/request/alpservice/feedback.php" class="form-index col gx-5">
                    ...
                    <button data-ok-title='<?= $arResult['PROPERTIES']['TITLE_SUCCESS_FEEDBACK']['~VALUE'] ?>'
                            ...
                            class="btn btn-blue" data-send-request="callbackAlpservice" type="submit">
        ...
        <div class="modal__container modal__container--callback" role="dialog" aria-modal="true">
            ...
            <div class="form-index-block">
                <form action="/request/alpservice/feedback.php" class="form-index col gx-5">
                    ...
                    <button data-ok-title='<?= $arResult['PROPERTIES']['TITLE_SUCCESS_FEEDBACK']['~VALUE'] ?>'
                            data-ok-text="<?= $arResult['PROPERTIES']['TEXT_SUCCESS_FEEDBACK']['~VALUE'] ?>"
                            class="btn btn-blue" data-send-request="orderAlpservice" type="submit">
                        <span><?= $arResult['PROPERTIES']['TEXT_BTN_FEEDBACK']['~VALUE'] ?></span>
                    </button>
                    <div class="form-group__text">
                        <p>
            ...
            <div data-order class="order">
                ...
                <div class="order__container">
                    <div class="order__inner">
                        ...
                        <form data-order-form class="order__form" action="/request/alpservice/feedback.php">
                            ...
                            <div class="order__nav g-20">
                                ...
                                <a data-send-request="quizAlpservice"
                            ...
                            <div class="contact-block">
                                <div class="modal-form-wrap">
                                    <div class="callback__form">
                                        <form action="/request/alpservice/feedback.php" data-calculator class="form-base">
                                            <div class="tab">
                                            ...
                                            <div class="tab__buttons">
                                                <button data-ok-title='<?= $arResult['PROPERTIES']['TEXT_SUCCESS_QUIZ']['~VALUE'] ?>'
                                                        data-send-request="calculatorAlpservice" class="btn btn-orange">
