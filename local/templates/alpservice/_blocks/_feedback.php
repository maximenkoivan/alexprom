 ...
 */
$formSettings = \classes\Models\Alpservice\Feedback\FormSettings::getInstance();
$formData = $formSettings->getPropertiesByPostfix('FEEDBACK');
$commonFormData = $formSettings->getPropertiesByPostfix('COMMON');
$request = \Bitrix\Main\Context::getCurrent()->getRequest();
?>
<section style="background-image: url('<?= CFile::GetPath($formData['IMAGE_FEEDBACK']['VALUE']) ?>');" class="questions-sections">
    <div class="container">
        <div class="questions">
            <div class="title big">
                ...
                <div class="form-index-block">
                    <form action="/request/alpservice/feedback.php" class="form-index col gx-5">
                        ...
                        <button data-ok-title='<?= $formData['TITLE_SUCCESS_FEEDBACK']['~VALUE'] ?>".'
                                ...
                                class="btn btn-blue form-field" data-send-request="callbackAlpservice">
