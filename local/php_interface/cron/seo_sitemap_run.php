<?php
//-- В версии seo модуля 23.300.000 уже нет данного файла
//-- Поэтому скорее всего скоро надо будет переделать его.
 ...
 * $arCurrentDir – данные из b_seo_sitemap_runtime по текущей записи,
            ...
            if ($v < $arValueSteps['iblock']) {
                    ...
                    if ( ! $currentIblock) {
                        ...
                        if (isset($NS['CURRENT_SECTION'])) {
                            ...
                            if ($arSection) {
                                ...
                                if ($arSitemap['SETTINGS']['IBLOCK_LIST'][$iblockId] == 'Y' && strlen(
                ...
                if ($v < $arValueSteps['iblock'] - 1) {
                    $msg = Loc::getMessage(
                        ...
                        array('#IBLOCK_NAME#' => $arCurrentIBlock['NAME'])
                    );
                    $v++;
                }
                ...
                if ($v < $arValueSteps['forum']) {
                    ...
                    if ($v < $arValueSteps['forum'] - 1) {
                        $msg = Loc::getMessage(
                            ...
                            array('#FORUM_NAME#' => $arCurrentForum['NAME'])
                        );
                        $v++;
                    }
