...
class Version20230914160154 extends Version
{
    protected $description = "Проекты/Настройки страницы (структура)";
  ...
  'ACTIVE' => 'Y',
  'SORT' => '510',
  'LIST_PAGE_URL' => '#SITE_DIR#/projects/index.php?ID=#IBLOCK_ID#',
