...
class Version20230825151442 extends Version
{
    protected $description = "Контент / Услуги (структура)";
  ...
  'DETAIL_PAGE_URL' => '/services/detail/#CODE#',
  'SECTION_PAGE_URL' => '/services/',
  'CANONICAL_PAGE_URL' => '',
  'PICTURE' => NULL,
  'DESCRIPTION' => '',
  ...
  'IPROPERTY_TEMPLATES' => 
  array (
    'ELEMENT_PAGE_TITLE' => '{=this.Name} в Москве и области',
  ),
  ...
  'VERSION' => '1',
  'USER_TYPE' => NULL,
  'USER_TYPE_SETTINGS' => 'a:1:{s:6:"height";i:100;}',
  'HINT' => '',
));
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Срок',
  ...
  'HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Что включает  в себя услуга?',
  'ACTIVE' => 'Y',
  'SORT' => '3',
  'CODE' => 'S1',
  'DEFAULT_VALUE' => 
  ...
  array (
    'NAME' => 'Название',
    'PROPERTY_S2' => 'Стоимость',
    'PROPERTY_S4' => 'Срок',
    'PROPERTY_S3' => 'Технологии и оборудование',
    'PROPERTY_S1' => 'Что включает в себя услуга?',
    'PREVIEW_PICTURE' => 'Основная картинка',
