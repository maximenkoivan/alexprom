...
class Version20231205160447 extends Version
{
    protected $description = "Свет/Контент (структура)";
  ...
  array (
    ...
    'PROPERTY_LINK_BTN_2' => 'Ссылка кнопки 2',
