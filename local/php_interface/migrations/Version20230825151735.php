...
class Version20230825151735 extends Version
{
    protected $description = "Служебный / Города (структура)";
  ...
  'API_CODE' => NULL,
  'REST_ON' => 'N',
  'NAME' => 'Города присутствия компании',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '',
  'DETAIL_PAGE_URL' => '',
  ...
  'Город присутствия|edit1' => 
  array (
    'NAME' => 'Название',
    'PROPERTY_S1' => 'Координаты для карты',
    'IBLOCK_ELEMENT_PROP_VALUE' => 'Значения свойств',
    'PROPERTY_S3' => 'Адрес',
    'PROPERTY_S2' => 'Телефон',
    'PROPERTY_S4' => 'Электронная почта',
    'PROPERTY_S5' => 'Дополнительная информация',
  ),
));
